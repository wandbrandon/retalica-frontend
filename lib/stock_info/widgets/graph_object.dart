...
class GraphObject extends StatefulWidget {
  ...
  const GraphObject({Key key, this.stock}) : super(key: key);
...
class GraphObjectState extends State<GraphObject> {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        Provider<Stock>.value(value: widget.stock),
      ...
      builder: (context, child) => Padding(
        ...
        child: AnimatedCrossFade(
          crossFadeState: context.watch<Stock>() == null
          ...
          secondChild: context.watch<Stock>() != null
              ? Container(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(padding: EdgeInsets.all(8), height: 300, child: StockLineGraph())
                    ],
                  ),
                )
